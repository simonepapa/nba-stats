const Season = ({ stats }: any) => {
  return (
    <tr>
      ...
      <td className="px-3 py-1 text-sm text-right whitespace-nowrap">{((stats.fgm / stats.fga) * 100).toFixed(2)}</td>
      <td className="px-3 py-1 text-sm text-right whitespace-nowrap">
        {stats.fg3m}-{stats.fg3a}
      </td>
      <td className="px-3 py-1 text-sm text-right whitespace-nowrap">{((stats.fg3m / stats.fg3a) * 100).toFixed(2)}</td>
      <td className="px-3 py-1 text-sm text-right whitespace-nowrap">
        {stats.ftm}-{stats.fta}
      </td>
      <td className="px-3 py-1 text-sm text-right whitespace-nowrap">{((stats.ftm / stats.fta) * 100).toFixed(2)}</td>
